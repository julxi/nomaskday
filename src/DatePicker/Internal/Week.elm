module DatePicker.Internal.Week exposing (Index(..), Week, calendarWeekDays, fromListWithDefault, getDay, indexedMap, toList, weeksInMonth)
...
dayInMonth : List (Week Date) -> Date -> Bool
dayInMonth month day =
    (List.map toList month) |> List.concat |> (List.member day)
